...
|                            | App Service                      | Platform-as-a-Service (PaaS) to host web apps and APIs with scaling and deployment slots. |                   | In progress |
|                            | Azure Functions                  | Serverless compute: triggers, bindings, and event-driven architecture.                    |                   | [ ]         |
|                            | Azure Kubernetes Service (AKS)   | Container orchestration: pods, deployments, scaling, ingress controllers.                 |                   | In progress         |
...
|                            | Azure OpenAI Service             | Integrate GPT and AI models into applications.                                            |                   | [ ]             |
|                            | Power Automate / Logic Apps      | Create business process automation and system integration.                                |                   | [ ]             |
>>>>>>> 70aa2cfd72a39d1dac121b3d286b82453653bd5c
