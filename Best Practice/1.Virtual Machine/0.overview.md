...
- Learn how to scale, and try to reproduce [Done]
- Config VNet, Subnet, Public, IP, and NSGs [Done]
- Disk & Storage and Snapshots & Backups [TODO]
- Basic Monitoring & Alerts [TODO]
- VMSS, LB, Jenkins [Done]
...
## 7. Upgrade the VMSS instance after assign the VMSS into LB

## 8. Find the public IP
