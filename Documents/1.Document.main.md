...
- Create a **Backend Pool** to define which VMs the Load Balancer should use to distribute traffic, *It is like a collection of VMs, which are in the same VNet and Region*
